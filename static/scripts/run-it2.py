...
os.system("python " + directory + \
          ...
          "applications/stopstalk/static/scripts/submissions2.py > " + \
          today_dir + "submissions2.log")
os.system("cat " + today_dir + "/submissions2.log")
...
os.system("python " + directory + \
          ...
          today_dir + "tags2.log")
os.system("cat " + today_dir + "/tags2.log")
